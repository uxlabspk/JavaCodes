...
// several integers. Assume that the src.first value read specifies the
// number of values to src.input from the user.
...
public class Q_16 {
    ...
    public void inputValues() {
        // taking src.input for how many numbers to compare
