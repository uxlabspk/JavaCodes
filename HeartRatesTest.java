...
public class HeartRatesTest
{
    ...
    public static void main(String[] args) 
    {
        ...
        // Printing information for first object.
        System.out.println("");
        ...
        System.out.println("Target heart reate lies in between " + hr_obj1.targetHeartRate1() + " to " + hr_obj1.targetHeartRate2() + " beats per minute.");
        System.out.println("");
        ...
        System.out.println("Target heart reate lies in between " + hr_obj2.targetHeartRate1() + " to " + hr_obj2.targetHeartRate2() + " beats per minute.");
    }
}
